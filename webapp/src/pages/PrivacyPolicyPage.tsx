      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="space-y-2.5 text-xs text-slate-700">
            ...
            <div className="p-3 rounded-xl bg-slate-50 border border-slate-200">
              <strong>F. AI Service Providers (Where Configured):</strong> If AI assistance features are explicitly activated, anonymized or authorized administrative text may be processed solely under appropriate contractual and security safeguards.
            </div>
            <div className="p-3 rounded-xl bg-slate-50 border border-slate-200">
