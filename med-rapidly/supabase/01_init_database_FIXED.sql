...
CREATE INDEX IF NOT EXISTS idx_departments_short_code ON departments(short_code);
...
CREATE INDEX IF NOT EXISTS idx_intake_links_hospital ON intake_links(hospital_id);
...
CREATE INDEX IF NOT EXISTS idx_doctor_availability_date ON doctor_availability(avail_date);
...
CREATE INDEX IF NOT EXISTS idx_appointments_doctor_date ON appointments(doctor_id, appt_date);
...
CREATE INDEX IF NOT EXISTS idx_queue_counters_doctor ON queue_counters(doctor_id);
CREATE INDEX IF NOT EXISTS idx_queue_counters_date ON queue_counters(counter_date);
...
CREATE INDEX IF NOT EXISTS idx_token_counters_hospital ON token_counters(hospital_id);
CREATE INDEX IF NOT EXISTS idx_token_counters_date ON token_counters(counter_date);
...
CREATE INDEX IF NOT EXISTS idx_prescription_items_consultation ON prescription_items(consultation_id);
...
CREATE INDEX IF NOT EXISTS idx_prescription_pdfs_consultation ON prescription_pdfs(consultation_id);
...
CREATE INDEX IF NOT EXISTS idx_prescription_access_pdf ON prescription_access(pdf_id);
CREATE INDEX IF NOT EXISTS idx_prescription_access_phone ON prescription_access(patient_phone);
...
CREATE INDEX IF NOT EXISTS idx_voice_calls_hospital ON voice_calls(hospital_id);
CREATE INDEX IF NOT EXISTS idx_voice_calls_caller_phone ON voice_calls(caller_phone);
